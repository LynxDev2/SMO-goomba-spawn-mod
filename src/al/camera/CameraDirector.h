...
public:
  ...
  al::CameraTicket *createCameraFromFactory(char const *creatorName,
                                            al::PlacementId const *,
                                            char const *, int priority,
                                            sead::Matrix34f const &);
  void createCamera(al::CameraPoser *, al::PlacementId const *, char const *,
                    int, sead::Matrix34f const &, bool);
  // void execute(void) override;
  void update(void);
  void createObjectCamera(al::PlacementId const *, char const *, char const *,
                          int, sead::Matrix34f const &);
  ...
  void
  setCameraParamTransferFuncTable(al::NameToCameraParamTransferFunc const *,
                                  int);
