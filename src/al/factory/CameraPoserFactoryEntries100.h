...
// Note: if needed, poser entries 1 and 2 can be merged together, and the second
// static list can be used for custom cameras

// 0xE in size
static al::NameToCreator<al::createCameraPoser> poserEntries[] = {
    // Vanilla Posers
    {"制限付きフォロー",
     &al::createCameraPoserFunction<CameraPoserFollowLimit>},
    ...
    {"レール移動",
     &al::createCameraPoserFunction<al::CameraPoserRailMoveLookAt>},
    {"キノピオ探検隊",
     &al::createCameraPoserFunction<al::CameraPoserKinopioBrigade>},
    {"会話用2点間", &al::createCameraPoserFunction<al::CameraPoserTalk>},
    {"映像撮影レール",
     &al::createCameraPoserFunction<al::CameraPoserRailMoveMovie>},
    // Custom Posers
    {"CameraPoserCustom",
     &cc::createCustomCameraPoser<
         cc::CameraPoserCustom>} // al::CameraPoserFollowSimple
};
...
static al::NameToCreator<al::createCameraPoser> poserEntries2[] = {
    ...
    {"キー移動レール移動",
     &al::createCameraPoserFunction<al::KeyMoveCameraRailMove>},
    {"キー移動ズーム", &al::createCameraPoserFunction<al::KeyMoveCameraZoom>},
    {"シナリオ紹介シンプルズームカメラ",
     &al::createCameraPoserFunction<ScenarioStartCameraPoserSimpleZoom>},
    {"シナリオ紹介レール移動カメラ",
     &al::createCameraPoserFunction<ScenarioStartCameraPoserRailMove>},
};
